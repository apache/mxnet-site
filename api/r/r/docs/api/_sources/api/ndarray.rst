...
:doc:`mx.nd.ones.like <./mx.nd.ones.like>`      Return an array of ones with the same shape and type
                                                as the input array
:doc:`mx.nd.zeros <./mx.nd.zeros>`              Generate an mx.nd.array object with zeros
:doc:`mx.nd.zeros.like <./mx.nd.zeros.like>`    Return an array of zeros with the same shape, type and storage type
                                                as the input array
==============================================  ===========================================================================================
...
:doc:`mx.nd.UpSampling <./mx.nd.UpSampling>`                              Performs nearest neighbor/bilinear up sampling to inputs
...
:doc:`mx.nd.broadcast.hypot <./mx.nd.broadcast.hypot>`                    Returns the hypotenuse of a right angled triangle, given its "legs"
                                                                          with broadcasting
...
:doc:`mx.nd.expand.dims <./mx.nd.expand.dims>`                            Inserts a new axis of size 1 into the array shape
...
:doc:`mx.nd.topk <./mx.nd.topk>`                        Returns the top *k* elements in an input array along the given axis.
...
:doc:`mx.nd.choose.element.0index <./mx.nd.choose.element.0index>`    Choose one element from each line(row for python, column for R/Julia) in lhs according to index indicated by rhs. This function assume rhs uses 0-based index
:doc:`mx.nd.diag <./mx.nd.diag>`                                      Extracts a diagonal or constructs a diagonal array
:doc:`mx.nd.fill.element.0index <./mx.nd.fill.element.0index>`        Fill one element of each line(row for python, column for R/Julia) in lhs according to index indicated by rhs and values indicated by mhs. This function assume rhs uses 0-based index
:doc:`mx.nd.gather.nd <./mx.nd.gather.nd>`                            Gather elements or slices from `data` and store to a tensor whose
                                                                      shape is defined by `indices`
:doc:`mx.nd.pick <./mx.nd.pick>`                                      Picks elements from an input array according to the input indices along the given axis
:doc:`mx.nd.ravel.multi.index <./mx.nd.ravel.multi.index>`            Converts a batch of index arrays into an array of flat indices. The operator follows numpy conventions so a single multi index is given by a column of the input matrix
...
:doc:`mx.nd.unravel.index <./mx.nd.unravel.index>`                    Converts an array of flat indices into a batch of index arrays. The operator follows numpy conventions so a single multi index is given by a column of the output matrix
====================================================================  ==========================================================================================================================================================================================
...
:doc:`mx.nd.gamma <./mx.nd.gamma>`                      Returns the gamma function (extension of the factorial function \
                                                        to the reals), computed element-wise on the input array
:doc:`mx.nd.gammaln <./mx.nd.gammaln>`                  Returns element-wise log of the absolute value of the gamma function \
                                                        of the input
...
:doc:`mx.nd.fix <./mx.nd.fix>`        Returns element-wise rounded value to the nearest \
...
========================================  ====================================================================================================
:doc:`mx.nd.arccosh <./mx.nd.arccosh>`    Returns the element-wise inverse hyperbolic cosine of the input array, \
                                          computed element-wise
:doc:`mx.nd.arcsinh <./mx.nd.arcsinh>`    Returns the element-wise inverse hyperbolic sine of the input array, \
                                          computed element-wise
:doc:`mx.nd.arctanh <./mx.nd.arctanh>`    Returns the element-wise inverse hyperbolic tangent of the input array, \
                                          computed element-wise
...
:doc:`mx.nd.Convolution.v1 <./mx.nd.Convolution.v1>`                          This operator is DEPRECATED. Apply convolution to input then add a bias
...
:doc:`mx.nd.RNN <./mx.nd.RNN>`                                                Applies recurrent layers to input data. Currently, vanilla RNN, LSTM and GRU are
...
:doc:`mx.nd.softmax <./mx.nd.softmax>`                                        Applies the softmax function
:doc:`mx.nd.SoftmaxActivation <./mx.nd.SoftmaxActivation>`                    Applies softmax activation to input. This is intended for internal layers
...
:doc:`mx.nd.relu <./mx.nd.relu>`                                              Computes rectified linear
