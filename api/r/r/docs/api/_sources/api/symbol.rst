...
:doc:`mx.symbol.ones_like <./mx.symbol.ones_like>`      Return an array of ones with the same shape and type
                                                        as the input array
:doc:`mx.symbol.zeros_like <./mx.symbol.zeros_like>`    Return an array of zeros with the same shape, type and storage type
                                                        as the input array
======================================================  ===========================================================================================
...
:doc:`mx.symbol.UpSampling <./mx.symbol.UpSampling>`                              Performs nearest neighbor/bilinear up sampling to inputs
...
:doc:`mx.symbol.broadcast_hypot <./mx.symbol.broadcast_hypot>`                    Returns the hypotenuse of a right angled triangle, given its "legs"
                                                                                  with broadcasting
...
:doc:`mx.symbol.expand_dims <./mx.symbol.expand_dims>`                            Inserts a new axis of size 1 into the array shape
...
:doc:`mx.symbol.topk <./mx.symbol.topk>`                        Returns the top *k* elements in an input array along the given axis.
...
============================================================================  ==========================================================================================================================================================================================
:doc:`mx.symbol.crop <./mx.symbol.crop>`                                      Slices a region of the array
...
:doc:`mx.symbol.choose_element_0index <./mx.symbol.choose_element_0index>`    Choose one element from each line(row for python, column for R/Julia) in lhs according to index indicated by rhs. This function assume rhs uses 0-based index
:doc:`mx.symbol.diag <./mx.symbol.diag>`                                      Extracts a diagonal or constructs a diagonal array
:doc:`mx.symbol.fill_element_0index <./mx.symbol.fill_element_0index>`        Fill one element of each line(row for python, column for R/Julia) in lhs according to index indicated by rhs and values indicated by mhs. This function assume rhs uses 0-based index
:doc:`mx.symbol.gather_nd <./mx.symbol.gather_nd>`                            Gather elements or slices from `data` and store to a tensor whose
...
:doc:`mx.symbol.ravel_multi_index <./mx.symbol.ravel_multi_index>`            Converts a batch of index arrays into an array of flat indices. The operator follows numpy conventions so a single multi index is given by a column of the input matrix
...
:doc:`mx.symbol.unravel_index <./mx.symbol.unravel_index>`                    Converts an array of flat indices into a batch of index arrays. The operator follows numpy conventions so a single multi index is given by a column of the output matrix
============================================================================  ==========================================================================================================================================================================================
...
:doc:`mx.symbol.gamma <./mx.symbol.gamma>`                      Returns the gamma function (extension of the factorial function \
                                                                to the reals), computed element-wise on the input array
:doc:`mx.symbol.gammaln <./mx.symbol.gammaln>`                  Returns element-wise log of the absolute value of the gamma function \
                                                                of the input
...
:doc:`mx.symbol.fix <./mx.symbol.fix>`        Returns element-wise rounded value to the nearest \
...
================================================  ====================================================================================================
:doc:`mx.symbol.arccosh <./mx.symbol.arccosh>`    Returns the element-wise inverse hyperbolic cosine of the input array, \
                                                  computed element-wise
:doc:`mx.symbol.arcsinh <./mx.symbol.arcsinh>`    Returns the element-wise inverse hyperbolic sine of the input array, \
                                                  computed element-wise
:doc:`mx.symbol.arctanh <./mx.symbol.arctanh>`    Returns the element-wise inverse hyperbolic tangent of the input array, \
                                                  computed element-wise
...
:doc:`mx.symbol.Convolution_v1 <./mx.symbol.Convolution_v1>`                          This operator is DEPRECATED. Apply convolution to input then add a bias
...
:doc:`mx.symbol.RNN <./mx.symbol.RNN>`                                                Applies recurrent layers to input data. Currently, vanilla RNN, LSTM and GRU are
...
:doc:`mx.symbol.SoftmaxActivation <./mx.symbol.SoftmaxActivation>`                    Applies softmax activation to input. This is intended for internal layers
...
:doc:`mx.symbol.relu <./mx.symbol.relu>`                                              Computes rectified linear
